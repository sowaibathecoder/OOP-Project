...
const programStart = async (person) => {
    ...
    do {
        ...
        if (select === "Teacher") {
            ...
            console.log(chalk.cyanBright("Teacher: Remember to submit your assignments on time."));
            console.log(chalk.cyanBright("Teacher: If you have any questions, feel free to ask."));
        ...
        if (select === "Student") {
            ...
            if (!selectedStudent) {
                ...
                console.log(chalk.redBright(`I'm ${chalk.bold.green(selectedStudent.name)}, and I'm doing well.`));
            }
            console.log(chalk.redBright(`${selectedStudent.name}: How was your day?`));
            console.log(chalk.redBright(`${selectedStudent.name}: I finished my homework.`));
            console.log(chalk.redBright(`${selectedStudent.name}: I'm excited about the upcoming project.`));
            console.log(chalk.redBright(`${selectedStudent.name}: Let's study together soon!\n`));
        }
